              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Input
                      ...
                      onChange={(e) => setProfile(p => p ? { ...p, avatar_url: e.target.value } : { display_name: user?.email?.split('@')[0] || '', avatar_url: e.target.value })}
                      placeholder="https://..."
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setProfile(p => p ? { ...p, display_name: e.target.value } : { display_name: e.target.value, avatar_url: profile?.avatar_url || '' })}
